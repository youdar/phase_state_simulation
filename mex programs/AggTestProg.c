...
void main(void)
{
    ...
    double t[10000],F[10000],M[10000],y0t[10000],g0t[10000],inagg[10000];
    double y[10000],g[10000];
    ...
    for (i = 1; i < m; ++i)
    {
        ...
        while (s < r )
        {
            ...
            if (rn > 9)
            {
                ...
                printf("AggKineticLoop - Error - rn>10.");
            }
            s += aa[rn]/a0;  
        }
        ...
        if (gn<0)
        {
            ...
            printf("AggKineticLoop - Error - gn<0\n");
        }
		...
		switch (rn)
        {
            ...
            default:
                ...
                printf("AggKineticLoop - Error - rn>9.");
                break;
        }
