...
%                         resFactor = 4+2*(nFit==2)+(nFit<5);   
            ...
            inputMatrix = inputMatrixUpdate2(initParameter,y(i),dy,x(i),resFactor,basePnum,adjPnum,ExplorDir,Extra_n,xDist,nFit,xFactor,yFactor,fittedFun,regularSol);
            figure(1)
