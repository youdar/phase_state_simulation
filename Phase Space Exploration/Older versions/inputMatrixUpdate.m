...
if nFit>1
    newY = y+dy;
    yy = newY/yFactor;                       % we evaluated the function with factorized arrays values
    ...
    inputMatrix(1,:) = UpdateVarArray2(initParameter,newY,newX,r,xFactor,yFactor,baseAngle,basePnum,adjPnum,Extra_n,xDist,resFactor,1);
    inputMatrix(2,:) = UpdateVarArray2(initParameter,newY,newX,r,xFactor,yFactor,baseAngle,basePnum,adjPnum,Extra_n,xDist,resFactor,2);
    inputMatrix(3,:) = UpdateVarArray2(initParameter,newY,newX,r,xFactor,yFactor,baseAngle,basePnum,adjPnum,Extra_n,xDist,resFactor,3);
    inputMatrix(4,:) = UpdateVarArray2(initParameter,newY,newX,r,xFactor,yFactor,baseAngle,basePnum,adjPnum,Extra_n,xDist,resFactor,4);                           
